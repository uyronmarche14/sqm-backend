 ...
 */
const parseFormDataArrays = (req, _res, next) => {
    if (req.body) {
 ...
 */
router.post('/', requirePermission('5M1EMAIN-11-01', 'add'), upload.any(), logUploads, handleUploadError, parseFormDataArrays, validate(CreateFiveM1ESchema), fiveM1EController.createApplication);
/**
 ...
 */
router.put('/:id', requireFiveM1EEditAccess, upload.any(), logUploads, handleUploadError, parseFormDataArrays, validate(UpdateFiveM1ESchema), fiveM1EController.updateApplication);
/**
