 ...
 */
router.post('/', upload.any(), logUploads, handleUploadError, parseFormDataArrays, validate(CreateFiveM1ESchema), fiveM1EController.createApplication);
/**
 ...
 */
router.put('/:id', upload.any(), logUploads, handleUploadError, parseFormDataArrays, validate(UpdateFiveM1ESchema), fiveM1EController.updateApplication);
/**
 * @route   DELETE /api/5m1e/:id
 * @desc    Delete 5M1E Record and all child data
 */
router.delete('/:id', fiveM1EController.deleteApplication);
/**
