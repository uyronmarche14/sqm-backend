 ...
 */
router.post('/', validate(CreateFiveM1ESchema), fiveM1EController.createApplication);
/**
 ...
 */
router.put('/:id', validate(UpdateFiveM1ESchema), fiveM1EController.updateApplication);
