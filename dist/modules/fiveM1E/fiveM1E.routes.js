 ...
 */
router.post('/', requirePermission('5M1E', 'add'), upload.any(), logUploads, handleUploadError, parseFormDataArrays, validate(CreateFiveM1ESchema), fiveM1EController.createApplication);
/**
 ...
 */
router.put('/:id', requirePermission('5M1E', 'edit'), upload.any(), logUploads, handleUploadError, parseFormDataArrays, validate(UpdateFiveM1ESchema), fiveM1EController.updateApplication);
/**
