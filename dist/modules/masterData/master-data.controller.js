...
const createController = (options) => ({
    getAll: async (_req, res, next) => {
        try {
            ...
            console.error('[MasterData] GET ALL error:', e);
            next(e);
        }
    },
    create: async (req, res, next) => {
        try {
            ...
            res.status(201).json(await masterDataService.create(options, payload));
        }
        catch (e) {
            console.error('[MasterData] CREATE error:', e);
            next(e);
        }
    },
    update: async (req, res, next) => {
        try {
            ...
            const payload = options.schema.parse(req.body);
            res.json(await masterDataService.update(options, id, payload));
        }
        catch (e) {
            console.error('[MasterData] UPDATE error:', e);
            next(e);
        }
    },
    delete: async (req, res, next) => {
        try {
            ...
            console.error('[MasterData] DELETE error:', e);
            next(e);
        }
    }
});
...
export const sitesCtrl = createController({
    ...
    toDB: (id, p) => ({ site_id: id, site_name: p.name, site_code: s(p.code), site_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const suppliersCtrl = createController({
    ...
    toDB: (id, p) => ({ supplier_id: id, supplier_name: p.name, site_id: p.siteId, location: s(p.location), supplier_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const rolesCtrl = createController({
    repo: repos.rolesRepo, mapper: mappers.role, schema: schemas.RoleSchema, idCol: 'role_id',
    toDB: (id, p) => ({ role_id: id, role_name: p.name, role_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const modelsCtrl = createController({
    ...
    toDB: (id, p) => ({ model_id: id, model_name: p.name, model_no: s(p.code), model_desc: s(p.description), product_id: p.productId, site_id: p.siteId, active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const productsCtrl = createController({
    ...
    toDB: (id, p) => ({ product_id: id, product_name: p.name, product_code: s(p.code), product_desc: s(p.description), site_id: p.siteId, active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const mfgAreasCtrl = createController({
    ...
    toDB: (id, p) => ({ mfg_area_id: id, mfg_area_name: p.mfg_area_name, mfg_area_desc: s(p.mfg_area_desc), active_flag: b(p.active_flag), updateby: 'SYSTEM' })
});
// ============================================================================
...
export const defectCatsCtrl = createController({
    ...
    toDB: (id, p) => ({ defectcategory_id: id, defectcategory_name: p.name, defectcategory_acronym: s(p.acronym), defectcategory_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const defectsCtrl = createController({
    ...
    toDB: (id, p) => ({ defect_id: id, defect_name: p.name, defect_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const defectClassesCtrl = createController({
    ...
    toDB: (id, p) => ({ defectclass_id: id, defectclass_name: p.name, defectclass_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const dispositionsCtrl = createController({
    ...
    toDB: (id, p) => ({ disposition_id: id, disposition_name: p.name, disposition_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const severityCtrl = createController({
    ...
    toDB: (id, p) => ({ severity_id: id, severity_name: p.name, severity_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const aqlCtrl = createController({
    repo: repos.aqlRepo, mapper: mappers.aql, schema: schemas.AQLSchema, idCol: 'aql_id',
    toDB: (id, p) => ({ aql_id: id, aql_name: p.name, minor: s(p.minor), major: s(p.major), site_id: p.siteId, aql_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
// ============================================================================
// Inspections & General
// ============================================================================
export const inspCatsCtrl = createController({
    ...
    toDB: (id, p) => ({ inspectioncat_id: id, inspectioncat_name: p.name, inspectioncat_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const inspMethodsCtrl = createController({
    ...
    toDB: (id, p) => ({ inspectionmethod_id: id, inspectionmethod_name: p.name, inspectionmethod_desc: s(p.description), default_temp: p.defaultTemp, default_hum: p.defaultHum, default_value: b(p.defaultValue), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const inspectorsCtrl = createController({
    ...
    toDB: (id, p) => ({ inspector_id: id, inspector_name: p.name, inspector_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const generalMasterCtrl = createController({
    ...
    toDB: (id, p) => ({ mnrtype_id: id, mnrtype_name: p.mnrtype_name, mnrtype_desc: s(p.mnrtype_desc), active_flag: b(p.active_flag), updateby: 'SYSTEM' })
});
// ============================================================================
// Parts Catalog
// ============================================================================
export const partClassCtrl = createController({
    ...
    toDB: (id, p) => ({ partclass_id: id, partclass_name: p.name, partclass_desc: s(p.description), site_id: p.siteId, active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const partTypesCtrl = createController({
    ...
    toDB: (id, p) => ({ parttype_id: id, parttype_name: p.name, parttype_code: s(p.code), parttype_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const partDataCatsCtrl = createController({
    ...
    toDB: (id, p) => ({ partdatacategory_id: id, partdatacategory_name: p.name, part_id: p.parentId, minimum: p.min, maximum: p.max, partdatacategory_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const partDimCatsCtrl = createController({
    ...
    toDB: (id, p) => ({ partdimensioncategory_id: id, partdimensioncategory_name: p.name, part_id: p.parentId, minimum: p.min, maximum: p.max, partdimensioncategory_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const partNoiseCatsCtrl = createController({
    ...
    toDB: (id, p) => ({ partnoisecategory_id: id, partnoisecategory_name: p.name, part_id: p.parentId, minimum: p.min, maximum: p.max, partnoisecategory_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const partsCatalogCtrl = createController({
    ...
    toDB: (id, p) => ({ part_id: id, part_code: p.code, part_name: p.name, site_id: p.siteId, part_desc: s(p.description), partclass_id: p.classId, parttype_id: p.typeId, aql_id: p.aqlId || '0', active_flag: b(p.active_flag), updateby: 'SYSTEM' })
});
// ============================================================================
// Forms & Security
// ============================================================================
export const formsCtrl = createController({
    ...
    toDB: (id, p) => ({ form_id: id, form_name: p.name, form_url: p.url, menu_group: p.menuGroup, icon: s(p.icon), form_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const roleAccessCtrl = createController({
    ...
    toDB: (id, p) => ({ roleaccess_id: id, role_id: p.roleId, form_id: p.formId, roleaccess_desc: s(p.description),
        ...
        active_flag: b(p.isActive), updateby: 'SYSTEM'
    })
});
// ============================================================================
// Suppliers Ex
...
export const supplierInchargesCtrl = createController({
    ...
    toDB: (id, p) => ({ Id: id, supplier_id: p.supplierId, user_id: p.userId, active_flag: b(p.isActive), updatedby: 'SYSTEM' }) // note updatedby instead of updateby in legacy
});
...
export const auditCatsCtrl = createController({
    ...
    toDB: (id, p) => ({ audit_category_id: id, audit_category_name: p.name, audit_category_code: p.code, audit_category_desc: s(p.description), with_rating: b(p.withRating), with_auditees: b(p.withAuditees), with_auditors: b(p.withAuditors), with_attendees: b(p.withAttendees), with_audit_plan: b(p.withAuditPlan), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const auditTypesCtrl = createController({
    ...
    toDB: (id, p) => ({ audit_type_id: id, audit_type_name: p.name, audit_type_desc: s(p.description), audit_category_id: p.categoryId, active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const criteriaCtrl = createController({
    ...
    toDB: (id, p) => ({ criteria_id: id, criteria_name: p.name, criteria_desc: s(p.description), active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const fiveM1ECatsCtrl = createController({
    ...
    toDB: (id, p) => ({ Category_ID: id, Category_name: p.name, Category_desc: s(p.description), Partclass_id: p.partClassId, Active_flag: b(p.isActive), updateby: 'SYSTEM' })
});
export const registrationsCtrl = createController({
    ...
    toDB: (id, p) => ({ registration_id: id, confirmation_code: p.confirmationCode, user_id: p.userId, registration_type: p.registrationType, confirmed: 0, active_flag: b(p.isActive), updateby: 'SYSTEM' }) // Legacy forced confirmed=0 on insert
});
// ============================================================================
...
export const faqItemsCtrl = createController({
    ...
    toDB: (id, p) => ({ faq_item_id: id, question: p.question, answer: p.answer, faq_category: p.faq_category ?? 0, sequence: p.sequence ?? 0, faq_item_desc: s(p.faq_item_desc), active_flag: b(p.active_flag), updateby: 'SYSTEM' })
});
export const certificationsCtrl = createController({
    ...
    toDB: (id, p) => ({ certification_id: id, certification_name: p.certification_name, certification_desc: s(p.certification_desc), active_flag: b(p.active_flag), updateby: 'SYSTEM' })
});
export const groupsCtrl = createController({
    ...
    toDB: (id, p) => ({ group_id: id, group_name: p.group_name, group_desc: s(p.group_desc), active_flag: b(p.active_flag), updateby: 'SYSTEM' })
});
export const trainingProgramsCtrl = createController({
    ...
    toDB: (id, p) => ({ training_program_id: id, training_program_name: p.training_program_name, training_program_desc: s(p.training_program_desc), active_flag: b(p.active_flag), updateby: 'SYSTEM' })
});
export const messageInfoCtrl = createController({
    ...
    toDB: (id, p) => ({ messageinfo_id: id, key_name: p.key_name, value: p.value || '', active_flag: b(p.active_flag), updateby: 'SYSTEM' })
});
