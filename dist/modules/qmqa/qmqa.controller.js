...
export class QmqaController {
    ...
    getSupplierResponsePayload(req) {
    ...
    verify = async (req, res, next) => {
        try {
            const { id } = QmqaIdParamSchema.parse({ params: req.params }).params;
            const result = await qmqaWorkflowService.verify(id, this.getUserId(req), this.getRoleId(req), this.getResponseReviewPayload(req), req.files || []);
            res.json(result);
        }
        catch (error) {
            next(error);
    ...
    saveResponse = async (req, res, next) => {
        try {
            const { id } = QmqaIdParamSchema.parse({ params: req.params }).params;
            const result = await qmqaWorkflowService.saveResponse(id, this.getUserId(req), this.getRoleId(req), this.getSupplierResponsePayload(req), req.files || []);
            res.json(result);
        }
        catch (error) {
            next(error);
    ...
    submitInitialResponse = async (req, res, next) => {
        try {
            const { id } = QmqaIdParamSchema.parse({ params: req.params }).params;
            const result = await qmqaWorkflowService.submitInitialResponse(id, this.getUserId(req), this.getRoleId(req), this.getSupplierResponsePayload(req), req.files || []);
            res.json(result);
        }
        catch (error) {
            next(error);
    ...
    submitFinalResponse = async (req, res, next) => {
        try {
            const { id } = QmqaIdParamSchema.parse({ params: req.params }).params;
            const result = await qmqaWorkflowService.submitFinalResponse(id, this.getUserId(req), this.getRoleId(req), this.getSupplierResponsePayload(req), req.files || []);
            res.json(result);
        }
        catch (error) {
            next(error);
    ...
    saveResponseReview = async (req, res, next) => {
        try {
            const { id } = QmqaIdParamSchema.parse({ params: req.params }).params;
            const result = await qmqaWorkflowService.saveResponseReview(id, this.getUserId(req), this.getRoleId(req), this.getResponseReviewPayload(req), req.files || []);
            res.json(result);
        }
        catch (error) {
            next(error);
    ...
    submitResponseReview = async (req, res, next) => {
        try {
            const { id } = QmqaIdParamSchema.parse({ params: req.params }).params;
            const result = await qmqaWorkflowService.submitResponseReview(id, this.getUserId(req), this.getRoleId(req), this.getResponseReviewPayload(req), req.files || []);
            res.json(result);
        }
        catch (error) {
            next(error);
