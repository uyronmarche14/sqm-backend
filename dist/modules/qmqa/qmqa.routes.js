...
export function createQmqaRoutes(variant = 'QMQA') {
    ...
    // Document Downloader
    router.get('/download/:attachmentId', requireModuleAccess(variant, 'view'), qmqaController.downloadAttachment);
    router.get('/download/:moduleType/:attachmentId', requireModuleAccess(variant, 'view'), qmqaController.downloadAttachment);
    router.get('/attachments/:attachmentId', requireModuleAccess(variant, 'view'), qmqaController.downloadAttachment);
    ...
    // ==========================================
    router.post('/records/:id/initial-report', requirePermission(formCodes.issued, 'edit'), uploadInitial.any(), logUploads, handleUploadError, qmqaController.saveInitialReport);
    router.post('/records/:id/final-report', requirePermission(formCodes.withFinalReport, 'submit'), uploadFinal.any(), logUploads, handleUploadError, qmqaController.submitFinalReport);
    return router;
}
