 ...
 */
export function generateControlNo(year, sequence, fromSchedule) {
 ...
 */
export function hasSchedulePrefix(controlNo) {
 ...
 */
export function validateControlNo(controlNo) {
 ...
 */
export function parsePercentageToNumber(percentageStr) {
