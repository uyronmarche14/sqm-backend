...
export type SQPRCreationInput = z.infer<typeof SqprCreateSchema>['body'];
export type SQPRUpdateInput = z.infer<typeof SqprUpdateSchema>['body'];
export type SQPRActionInput = z.infer<typeof SqprActionSchema>['body'];
